...
const Navbar = () => {
  ...
  return (
    <header className={cn(
      "fixed top-0 left-0 w-full z-[60] transition-all duration-500",
      isScrolled ? "bg-white/70 backdrop-blur-xl py-3 border-b border-slate-100/50 shadow-lg shadow-sky-500/5" : "bg-transparent py-6"
    )}>
